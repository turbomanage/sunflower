...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["sunflower", "sunflower.dart", , B, {
  ...
  main: [function() {
    var t1, t2;
    t1 = $.get$slider();
    t2 = J.get$onChange$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new B.main_closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onMouseMove$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new B.main_closure0()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t1 = J.get$onKeyDown$x(t1);
    ...
    t1 = $.get$phiSlider();
    t2 = J.get$onChange$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new B.main_closure2()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onMouseMove$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new B.main_closure3()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t1 = J.get$onKeyDown$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.main_closure4()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    B.draw();
  }, "call$0", "main$closure", 0, 0, 2],
  draw: function() {
    var t1, i, t2, theta, r, t3;
    $.seeds = H.Primitives_parseInt(J.get$value$x($.get$slider()), null, null);
    t1 = H.Primitives_parseInt(J.get$value$x($.get$phiSlider()), null, null);
    if (typeof t1 !== "number")
      return t1.$div();
    $.phi = t1 / 10000;
    t1 = $.get$context();
    ...
    t1.lineWidth = 1;
    t1.strokeStyle = "blue";
    t1.arc(150, 150, Math.sqrt(H.checkNum($.seeds)) * 4, 0, 6.283185307179586, false);
    t1.closePath();
    t1.stroke();
    $.get$notes().textContent = H.S($.seeds) + " seeds";
    $.get$theta().textContent = H.S($.get$phi()) + " = phi";
  },
  main_closure: {
    "^": "Closure:10;",
    call$1: function(e) {
...
Isolate.$lazy($, "phiSlider", "phiSlider", "get$phiSlider", function() {
  return document.querySelector("#phi_slider");
});
Isolate.$lazy($, "notes", "notes", "get$notes", function() {
  return document.querySelector("#notes");
});
Isolate.$lazy($, "theta", "theta", "get$theta", function() {
  return document.querySelector("#theta");
});
Isolate.$lazy($, "PHI", "PHI", "get$PHI", function() {
  return (Math.sqrt(H.checkNum(5)) + 1) / 2;
});
Isolate.$lazy($, "phi", "phi", "get$phi", function() {
  return $.get$PHI();
});
